			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<select name="t_package" id="t_package" class="form-control" data-style="btn-primary">
						...
						$sql2=mysql_query("select * from packages where p_name like '%PRIME_%'");
						while($row2=mysql_fetch_array($sql2))
						{
							...
							if ($p_status1=='ACTIVE')
							{
								print "<option value='$package_id1'>$p_name1</option>";
							}
						}
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="d_package" id="d_package" class="form-control" data-style="btn-primary">
							...
							$sql2=mysql_query("select * from packages where p_name like 'D_%'");
							while($row2=mysql_fetch_array($sql2))
							{
								$package_id1=$row2['package_id'];
								$p_name1=$row2['p_name'];
