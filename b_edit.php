...
<body>
	<div class = "container" >
		...
		<tr><th>#</th><th>PACKAGE</th><th>START_DATE</th><th>END_DATE</th><th>DAYS_REMAINING</th>
			...
			$sql=mysqli_query($connection,"SELECT *,DATEDIFF(b.end_date,current_date) as days_left FROM basic_package b join packages p on b.package_id=p.package_id where b.member_id=$member_id order by b.end_date");
			$i=1;
		...
		action="inserter2.php?member_id=<?php echo $_GET['member_id'];?>&package=basic&redirect=no">
		<br>
		<br>
		<br>
